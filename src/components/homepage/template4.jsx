        ...
        <Box sx={{ flexGrow: 1, boxShadow: 1 }}>
          <Grid container spacing={2} >
            ...
            <Grid xs={12} >
              ...
              <Typography variant='h5' color="#df487f"  > Objective <FlagCircleIcon /></Typography>
            ...
            <Grid xs={12}  >
              <Typography variant='h5' color="#df487f"  >Work Experience <WorkIcon /></Typography>
              <Item >
            ...
            <Grid xs={12} >
              <Typography variant='h5' color="#df487f"  > Education Detail <SchoolIcon /></Typography>
            ...
            <Grid xs={12}>
              <Typography variant='h5' color="#df487f"  >Key Skills<KeyIcon /></Typography>
              <Item>
