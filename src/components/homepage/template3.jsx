  ...
  return (
    ...
    <div style={{ width: '210mm', height: "297mm" }} >
      <Paper id="Temp3" elevation={3}  >
        ...
        <Grid container spacing={2} backgroundColor="#4C9E1F" color="white" borderRadius={2} >
          <Grid xs={6} >
        ...
        <Box sx={{ flexGrow: 1, boxShadow: 1 }}>
          <Grid container spacing={2} >
            ...
            <Grid xs={12} >
              ...
              <Typography variant='h5' color="#4C9E1F"  > Objective <FlagCircleIcon /></Typography>
            ...
            <Grid xs={12}  >
              <Typography variant='h5' color="#4C9E1F"  >Work Experience <WorkIcon /></Typography>
              <Item >
            ...
            <Grid xs={12} >
              <Typography variant='h5' color="#4C9E1F" > Education Detail <SchoolIcon /></Typography>
            ...
            <Grid xs={12}>
              <Typography variant='h5' color="#4C9E1F"  >Key Skills<KeyIcon /></Typography>
              <Item>
