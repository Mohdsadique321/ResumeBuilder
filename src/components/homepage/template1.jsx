  ...
  return (
    ...
    <div style={{ width: '210mm', height: "297mm" }} >
      <Paper id="Temp1" elevation={3}  >
        ...
        <Grid container spacing={2} backgroundColor="#1F4C9E" color="white" borderRadius={2} >
          <Grid xs={6} >
        ...
        <Box sx={{ flexGrow: 1, boxShadow: 1 }}>
          <Grid container spacing={2} >
            ...
            <Grid xs={12} >
              ...
              <Typography variant='h5' color="#1F4C9E"  > Objective <FlagCircleIcon /></Typography>
            ...
            <Grid xs={12}  >
              <Typography variant='h5' color="#1F4C9E"  >Work Experience <WorkIcon /></Typography>
              <Item >
            ...
            <Grid xs={12} >
              <Typography variant='h5' color="#1F4C9E"  > Education Detail <SchoolIcon /></Typography>
            ...
            <Grid xs={12}>
              <Typography variant='h5' color="#1F4C9E"  >Key Skills<KeyIcon /></Typography>
              <Item>
